import torch
from methods.DDPG.ddpg import DDPG
...
class TrainAndTestDDPG:
    ...
    def __init__(self, cfg):
        ...
        self.agent = DDPG(n_states, n_actions, cfg)
    ...
    def train(self):
        ...
        for i_ep in range(self.cfg.train_eps):
            ...
            rewards.append(0.97 * rewards[-1] + 0.03 * ep_reward) if rewards else rewards.append(ep_reward)
            ...
            completion_ratios.append(0.95 * completion_ratios[-1] + 0.05 * completion_ratio) \
