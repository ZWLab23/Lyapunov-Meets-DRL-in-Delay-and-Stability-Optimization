...
class TrainAndTestDQN:
    ...
    def __init__(self, cfg):
        ...
        self.agent = DQN(n_states, n_actions, cfg)
    ...
    def train(self):
        ...
        for i_ep in range(self.cfg.train_eps):
            ...
            completion_ratios.append(0.9 * completion_ratios[-1] + 0.1 * completion_ratio) \
