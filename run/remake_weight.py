...
import datetime
import numpy as np
from common.utils_remake import plot_rewards, plot_backlogs, plot_delays
...
class PlotConfig:
    ...
    def __init__(self) -> None:
        self.info = "weight"
        self.change = [50, 100, 200, 400]
        self.plot_path = parent_path + "/results/" + "/weight/" + "/remake/"
        self.save = True  # 是否保存图片


read_path = parent_path + "/results/" + "/weight/" + "/weight=4,speed=7/20230825-220024/results"
