...
class PlotConfig:
    ...
    def __init__(self) -> None:
        ...
        self.change = [6, 7, 8, 9]
        self.plot_path = parent_path + "/results/" + "/rsu/" + "/remake/"
        self.save = True  # 是否保存图片


read_path = parent_path + "/results/" + "/rsu/" + "/weight=4,speed=100/20230817-105409/results"
...
plot_average_queue_lengths(queue_1, queue_2, queue_3, queue_4, cfg=cfg, tag_1="train", tag_2="queue")
