...
class PlotConfig:
    ...
    def __init__(self, weight, speed) -> None:
        self.device = device
        self.config = VehicularEnvConfig()
        self.info = "vehicle number"
        self.change = list(self.config.vehicle_number_dict.values())  # 读取车流信息
...
def traffic_comparison():
    ...
    make_dir(plot_cfg.model_path + '/traffic_1/', plot_cfg.model_path + '/traffic_2/',
             plot_cfg.model_path + '/traffic_3/', plot_cfg.model_path + '/traffic_4/')
    ...
    # 保存模型
    sac_mind_1.agent.save(plot_cfg.model_path + '/traffic_1/')
    sac_mind_2.agent.save(plot_cfg.model_path + '/traffic_2/')
    sac_mind_3.agent.save(plot_cfg.model_path + '/traffic_3/')
    sac_mind_4.agent.save(plot_cfg.model_path + '/traffic_4/')
    ...
    # -----------------------------------测试过程----------------------------------- #
    # 导入模型
    sac_mind_1.agent.load(plot_cfg.model_path + '/traffic_1/')
    sac_mind_2.agent.load(plot_cfg.model_path + '/traffic_2/')
    sac_mind_3.agent.load(plot_cfg.model_path + '/traffic_3/')
    sac_mind_4.agent.load(plot_cfg.model_path + '/traffic_4/')
